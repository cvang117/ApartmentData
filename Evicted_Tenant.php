...
$query = "SELECT DISTINCT Evicted_Tenant_Name FROM evicted_tenant ORDER BY Evicted_Tenant_Name ASC";
...
<html>
 ...
 <body>
  <div class="container">
   <br />
   <h2 align="center">Evicted Tenant List</h2><br />
...
$(document).ready(function(){
    $('.search-box input[type="text"]').on("keyup input", function(){
        ...
        if(inputVal.length){
            $.get("backend-search-evicted.php", {term: inputVal}).done(function(data){
   ...
   */
   ...
   <div class="table-responsive">
    <table class="table table-striped table-bordered">
     <thead>
      <tr>
       <th>Evicted Tenant Name</th>
       <th>Evicted SSN</th>
       <th>Evicted Phone</th>
	   <th>Evicted Apartment Name</th>
	   <th>Deletion Date</th>
      </tr>
     </thead>
     <tbody>
